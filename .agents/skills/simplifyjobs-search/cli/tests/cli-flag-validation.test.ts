...
describe("simplifyjobs CLI flag validation", () => {
  ...
  test("bare --help with no command exits 1 (a lone --help still needs a subcommand)", async () => {
...
describe("unknown flag rejection", () => {
  ...
  // with a JSON error on stderr rather than being silently discarded.
